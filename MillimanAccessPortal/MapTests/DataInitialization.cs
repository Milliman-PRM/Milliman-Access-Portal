...
namespace MapTests
{
    ...
    internal class DataInitialization
    {
        ...
        public UserManager<ApplicationUser> UserManager { get => MockUserManager.Object; }
        ...
        */
        ...
        private void GenerateDependencies()
        {
            ...
            AuthorizationService = GenerateAuthorizationService(DbContextObject, UserManager, LoggerFactory);
            MockAuditLogger = TestResourcesLib.MockAuditLogger.New();
            QueriesObj = new StandardQueries(DbContextObject, UserManager, MockAuditLogger.Object);
            ...
            UserQueriesObj = new UserQueries(DbContextObject);
            ...
            MockSignInManager = TestResourcesLib.MockSignInManager.New(UserManager, AuthenticationServiceObject, LoggerFactory.CreateLogger<DefaultAuthorizationService>());
        }
        */
