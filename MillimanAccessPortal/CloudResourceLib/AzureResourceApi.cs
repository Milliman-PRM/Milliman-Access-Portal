...
namespace CloudResourceLib
{
    ...
    public static class AzureResourceApi
    {
        ...
        public static void InitClients(IEnumerable<AzureClientCredential> credentials /*, location? */)
        {
            _containerRegistryClient = _containerInstanceClient = _storageClient = null;
            _resourceLocation= AzureLocation.EastUS;  // TODO get this right, and don't break DR plan
