...
namespace MillimanAccessPortal.Utilities
{
    public class NotifySupport
    {
        ...
        /// <returns></returns>
        public void sendSupportMail(string messageArg, string reason)
        {
            ...
            _messageSender.QueueEmail(supportAddress, $"Automated support notification - {reason}", messageArg, sender);
        }
    }
}
