...
namespace MillimanAccessPortal.Migrations
{
    ...
    [Migration("20230206215805_SupportEf7")]
    partial class SupportEf7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "authentication_type", new[] { "default", "ws_federation" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "content_type_enum", new[] { "unknown", "qlikview", "html", "pdf", "file_download", "power_bi", "container_app" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "file_drop_notification_type", new[] { "file_write", "file_read", "file_delete" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "publication_status", new[] { "unknown", "canceled", "rejected", "validating", "queued", "processing", "post_process_ready", "post_processing", "processed", "confirming", "confirmed", "replaced", "error" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "reduction_status_enum", new[] { "unspecified", "canceled", "rejected", "validating", "queued", "reducing", "reduced", "live", "replaced", "warning", "error" });
