...
C:\'Program Files (x86)'\'Microsoft Visual Studio'\2017\Professional\MSBuild\15.0\Bin\MSBuild /t:publish /p:WebProjectOutDir=$branchFolder /p:OutDir=$branchFolder /p:DeployOnBuild=True
