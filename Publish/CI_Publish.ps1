...
octo create-release --project "Milliman Access Portal" --apiKey "API-ZUC8Y6MXCF4ZNGZML0NTJK7XAJW" --server "http://indy-prmdeploy.milliman.com" --packagesFolder="web" --waitfordeployment --cancelontimeout --progress
