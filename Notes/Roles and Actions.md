...
| View | Action | System Admin | Root Client Creator | Client Admin | User Manager | Content Manager | Content User |
| :--- | :----- | :----------: | :-----------------: | :----------: | :----------: | :-------------: | :----------: |
...
|||||||||
|REPORT VIEW|View Report View||||||X|
||View assigned content items||||||X|
